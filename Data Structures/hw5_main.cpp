...
void StudentTests() {
  ...
  TrainCar* t;
   ...
   MTRand_int32 mtrand_fixed_seed(42);
  std::cout << "============================================================================" << std::endl;
  std::cout << "SHIP FREIGHT STUDENT TEST #1 (FIXED SEED) [10 engines, 45 freight cars, 45 minspeed, 14 maxcars]" << std::endl;
  ShipFreightHelper(mtrand_fixed_seed,10,45,45,14);

  std::cout << "============================================================================" << std::endl;
  std::cout << "SHIP FREIGHT STUDENT TEST #2 (FIXED SEED) [4 engines, 15 freight cars, 60 minspeed, 7 maxcars]" << std::endl;
  ShipFreightHelper(mtrand_fixed_seed,4,15,60,7);

  std::cout << "============================================================================" << std::endl;
  std::cout << "SHIP FREIGHT STUDENT TEST #3 (FIXED SEED) [8 engines, 30 freight cars, 55 minspeed, 16 maxcars]" << std::endl;
  ShipFreightHelper(mtrand_fixed_seed,8,30,55,16);

  std::cout << "============================================================================" << std::endl;
  std::cout << "SHIP FREIGHT STUDENT TEST #4 (FIXED SEED) [7 engines, 30 freight cars, 60 minspeed, 10 maxcars]" << std::endl;
  ShipFreightHelper(mtrand_fixed_seed,7,30,60,10);

  std::cout << "============================================================================" << std::endl;
  std::cout << "SHIP FREIGHT STUDENT TEST #5 (FIXED SEED) [5 engines, 18 freight cars, 60 minspeed, 6 maxcars]" << std::endl;
  ShipFreightHelper(mtrand_fixed_seed,5,18,60,6);
  ...
  PushBack(t, TrainCar::MakeEngine());
  PushBack(t, TrainCar::MakeSleepingCar());
  SeparateTestHelper(t, "Student Test Separate #1");
  ...
  PushBack(t, TrainCar::MakeDiningCar());
  PushBack(t, TrainCar::MakeSleepingCar());
  SeparateTestHelper(t, "Student Test Separate #2");
  ...
  PushBack(t, TrainCar::MakeSleepingCar());
  PushBack(t, TrainCar::MakePassengerCar());
  SeparateTestHelper(t, "Student Test Separate #3");
  ...
  PushBack(t, TrainCar::MakePassengerCar());
  PushBack(t, TrainCar::MakePassengerCar());
  SeparateTestHelper(t, "Student Test Separate #4");
  ...
  PushBack(t, TrainCar::MakeSleepingCar());
  PushBack(t, TrainCar::MakeEngine());
  SeparateTestHelper(t, "Student Test Separate #5");
